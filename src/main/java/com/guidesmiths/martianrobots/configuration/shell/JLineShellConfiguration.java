...
public class JLineShellConfiguration {
    ...
    public ApplicationRunner interactiveApplicationRunner(Parser parser, Environment environment) {
        return new InteractiveShellApplicationRunner(customLineReader(), promptProvider, parser, shell, environment);
    }
    ...
    @Bean
    public LineReader customLineReader() {
                ...
                .highlighter(new Highlighter() {
                    ...
                    public AttributedString highlight(LineReader reader, String buffer) {
                        ...
                        if (best != null) {
                            ...
                            return new AttributedString(buffer, AttributedStyle.DEFAULT.foreground(AttributedStyle.BLACK));
                        }
                    }
                })
                .parser(parser());
